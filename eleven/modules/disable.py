...
if is_module_loaded(FILENAME):
    ...
    from eleven.modules.sql import disable_sql as sql
    ...
    def disable_del(update, context):
        ...
        if len(msg.text.split()) >= 2:
            ...
            if args == "yes" or args == "on" or args == "ya":
                ...
                send_message(update.effective_message, languages.tl(update.effective_message, "Unrecognised argument - please use 'yes', or 'no'."))
        else:
