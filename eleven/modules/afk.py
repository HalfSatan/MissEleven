...
from eleven import dispatcher, OWNER_ID, SUDO_USERS, SUPPORT_USERS, spamcheck
from eleven.modules.disable import DisableAbleCommandHandler, DisableAbleMessageHandler
from eleven.modules.sql import afk_sql as sql
from eleven.modules.users import get_user_id
            ...
            if sql.is_afk(user_id):
                ...
                if valid:
                    if not reason:
                        ...
                        res = tl(update.effective_message, "{} is AFK! \nBecause: {}").format(fst_name, reason)
