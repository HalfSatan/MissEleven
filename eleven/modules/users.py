...
import eleven.modules.sql.users_sql as sql
from eleven import dispatcher, OWNER_ID, LOGGER
...
def broadcast(update, context):
    ...
    if len(to_send) >= 2:
        ...
        send_message(update.effective_message, "The broadcast is complete. {} Group failed to receive message, maybe because it was kicked.".format(failed))
