...
__help__ = f"""
Chatbot utilizes the CoffeeHouse API and allows Eleven to talk back making your chat more interactive.
In future we might make it open for any chat and controllable by group admins.
Powered by CoffeeHouse (https://coffeehouse.intellivoid.net/) from @Intellivoid
Commands: These only work for Eleven Staff users. 
...
LIST_CB_CHATS_HANDLER = CommandHandler("listaichats", list_chatbot_chats, filters=CustomFilters.sudo_filter)
